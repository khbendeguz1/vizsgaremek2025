...
<head>
    ...
    <style>
        ...
        /* Navbar */
        .navbar {
            background: rgba(0, 0, 0, 0) !important; /* Átlátszó háttér */
            border: none; /* Eltünteti a határokat */
        }
        .navbar-brand, .nav-link {
            color: white !important; /* Fehér színű szöveg */
        }
        .navbar-toggler-icon {
            background-color: white; /* Fehér menü ikon */
        }
        .navbar-nav .nav-item.active .nav-link {
            color: #ff758c !important; /* Aktív link színe */
        }
